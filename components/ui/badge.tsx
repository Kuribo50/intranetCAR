...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-medical-900 text-slate-50 shadow hover:bg-medical-900/80",
        secondary:
        ...
        success:
          "border-transparent bg-sanitary-500/15 text-sanitary-500 hover:bg-sanitary-500/25",
        warning:
